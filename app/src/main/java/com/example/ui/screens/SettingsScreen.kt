        ...
        Card(
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Row(
                    ...
                    Text("🎵 MUZICĂ DE FUNDAL", fontWeight = FontWeight.Medium)
                    Switch(
                        checked = isMusic,
                        onCheckedChange = { viewModel.setMusic(it) },
                ...
                Row(
                    ...
                    Text("🔊 EFECTE SONORE", fontWeight = FontWeight.Medium)
                    Switch(
                        checked = isSfx,
                        onCheckedChange = { viewModel.setSfx(it) },
